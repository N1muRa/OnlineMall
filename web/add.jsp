...
<div class="products">
    <div class="container">
        <h2 style="margin-bottom: 0px;">Add Shoes</h2>
        <div class="col-md-9 product-model-sec">
            <div class="table_row" style="float: left;margin-top: 0px;">
                <table border="1" cellpadding="0" bgcolor="white" width="400" height="75" bordercolor="#fff" align="center" style="margin-bottom: 50px; ">
                    ...
                    <tr>
                        <td align="left" width="50" valign="middle"  height="60"><h1>Picture</h1></td>
                        <td align="left" width="200" valign="middle" height="60">
                            <div id="Picture">
                            <img src="" alt="" width="80" height="80" style="margin-bottom: 10px;" id="Ava"><br>
                            </div>
                        <input type="button" onclick="upload()" style="border: 2px solid #F07818;color: #FFF;font-size: 0.8em;padding: 0.5em 1.5em;transition: 0.5s all;-webkit-transition: 0.5s all;-moz-transition: 0.5s all;-o-transition: 0.5s all;display:inline-block; outline: none;background-color: #F07818; -moz-border-radius: 10px;-webkit-border-radius: 10px;border-radius:15px;" value="Upload"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="left" width="50" valign="middle"  height="60"><h1>Function</h1></td>
                        <td align="left" width="200" valign="middle" height="60">
                    ...
                    <tr>
                        <td align="left" width="50" valign="middle"  height="60"><h1>Price</h1></td>
                        <td align="left" width="200" valign="middle" height="60"><input type="text" id="Price" value=""></td>
                    </tr>
                    <tr>
                        <td align="left" width="50" valign="middle"  height="60"><h1>Store</h1></td>
                        <td align="left" width="200" valign="middle" height="60"><input type="text" id="Store" value="Please put in number" onfocus="javascript:if(this.value=='Please put in number')this.value='';">
                    </tr>
                    <tr>
                        <td align="left" width="50" valign="middle"  height="60"><h1>Discribe</h1></td>
                        <td align="left" width="200" valign="middle" height="60"><input type="text" id="d1" value="" style="margin-bottom: 5px;"><br><input type="text" id="d2" value="">
                    </tr>
                    <tr>
                        <td align="right" width="50" valign="middle"  height="60"></td>
                        <td align="center" width="200" valign="middle" height="60">
                            <input type="submit" value="Confirm" style="border: 2px solid #F07818;color: #FFF;font-size: 1.1em;padding: 0.5em 1.5em;transition: 0.5s all;-webkit-transition: 0.5s all;-moz-transition: 0.5s all;-o-transition: 0.5s all;display:inline-block; outline: none;background-color: #F07818; -moz-border-radius: 10px;-webkit-border-radius: 15px;border-radius:15px; "/></td>
                    </tr>
                </table>
            </div>
        </div>
