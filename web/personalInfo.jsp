...
<body>
	...
	<table border="1" cellpadding="0" bgcolor="white" width="400"  height="75" bordercolor="#FFFFFF" align="center" style="margin-bottom: 50px;margin-top:50px; ">
       ...
       <tr>
	      ...
	      <td align="left" width="100" valign="middle"  height="60"><img src="images/T1.jpg" alt="" width="80" height="80" style="margin-bottom: 10px;">
	      <input type="file">
       </tr>
       <tr>
       ...
       <tr>
         <td align="left" width="50" valign="middle"  height="60"><h1>Gender</h1>
	      ...
	      <td align="left" width="100" valign="middle" height="60"><input type="radio" name="gender" value="Female"><h style="margin-right:100px;">Female</h>
          <input type="radio" name="gender" value="Male" checked><h>Male</h>
	      </td>
       </tr>
        <tr>
