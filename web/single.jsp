		...
		<div class="container">
			<div class="single-grids">
				<div class="col-md-4 single-grid">
					<div class="flexslider">
						<ul class="slides">
							...
							%>
							<li data-thumb="<%=add%>">
								<div class="thumb-image"> <img src="<%=add%>" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<%
										}
									}
				...
				<div class="col-md-4 single-grid simpleCart_shelfItem">
					<h3 align="center"><%=commodity.getName()%></h3>
					...
					<div class="galry">
						<div class="prices">
							<h5 class="item_price"><%=commodity.getPrice()%></h5>
						</div>
						<div class="rating">
							<span>☆</span>
							<span>☆</span>
